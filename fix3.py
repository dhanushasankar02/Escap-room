...
# headCommon is everything from <!DOCTYPE html> until /* 1. Hero Section */
...
# Find the end of </style> in index.html to extract the rest down to </nav>
scriptAndNavMatch = re.search(r'(<\/style>[\s\S]*?<\/nav>)', indexHtml)
# Remove the </style> since it's already included in contactCSS
