...
# Search for the TRUE Event Inquiry section by matching "Private Events"
# This will skip the false duplicates of the Raven form.
restMatch = re.search(r'(<section class="event-inquiry-section">[\s\S]*?<h2 class="section-title">Private Events & Buyouts<\/h2>[\s\S]*)', contactHtml)
...
if restMatch:
    ...
    print("Failed to match true Event Inquiry section")
